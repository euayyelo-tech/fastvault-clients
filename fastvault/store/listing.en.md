# Store listing — FastVault Password Manager (English)
...
FastVault is compatible with the official Bitwarden apps. Bitwarden is a trademark of Bitwarden, Inc., which is not affiliated with FastVault.

Operated by FSITES LTD, registered in England and Wales. Support: https://fastvault.app/support · Privacy: https://fastvault.app/legal/privacy · Source code (GPL-3.0): https://github.com/euayyelo-tech/fastvault-clients

## Category

Productivity (Chrome, Edge) · Privacy & Security (Firefox)

## Language

English only for now (the extension itself ships upstream's translations; the listing is English).
